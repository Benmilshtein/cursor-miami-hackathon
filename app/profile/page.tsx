...
const DASHBOARD_COPY = {
  en: {
    ...
    createTeamDesc: "Start a team (2–5 people) and share an invite code — solo projects aren't allowed.",
    ...
    memberBadge: "Member",
    noTeamState:
      "You are not in a team yet. Pair up: create a team with teammates, join with a code, or get matched — solo projects aren't allowed.",
