    ...
    >
      ...
      >
        ...
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-8 bg-gradient-to-r from-[#ff7a45] via-[#ff9a62] to-[#2ee6c5] bg-clip-text text-transparent"
        >
          {t("hero", "subtitle")}
        </motion.h2>
